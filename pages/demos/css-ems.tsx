...
`}
      ...
      <p>This approach admittedly leads to some very large text on a large UHD monitor like the one I own, but my eyesight isn't what it&apos;s used to and I like being able to make the text larger merely by making the window for the app larger.</p>
      </section>
    </Page>
  )
}