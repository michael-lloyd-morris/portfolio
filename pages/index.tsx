    ...
    <Page>
      ...
      <section>
        ...
        <ul className="tech">
          ...
          <li className="logo cucumber"><strong>Cucumber</strong> is the leading test automation tool for implementing the Behavior Driven Design (BDD) approach to coding. I have professional experience with the PHP, Java and JavaScript implementations. The automated tests for this page are written with Cucumber.</li>
